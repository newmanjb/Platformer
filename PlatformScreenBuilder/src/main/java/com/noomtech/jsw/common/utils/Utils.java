...
import com.noomtech.jsw.platformscreen.gameobjects.objects.JSW;
...
public class Utils {
    ...
    private static final String ANIMATION_FRAMES_FOLDER = Utils.class.getClassLoader().getResource("animationFrames").getFile() +
            File.separator;
     ...
     *                               the {@link Utils#ANIMATION_FRAMES_FOLDER}
